...
const DESCRIPTION = "List of third-party subprocessors used by Jabberwock to process customer data."
		...
		<>
			<div className="container mx-auto px-4 py-12 sm:px-6 lg:px-8">
				<div className="prose prose-lg mx-auto max-w-5xl dark:prose-invert">
					...
					<p className="lead">Jabberwock engages the following third parties to process Customer Data.</p>
