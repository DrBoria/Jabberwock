...
export const content: AgentPageContent = {
	...
	hero: {
		...
		paragraphs: [
			"Jabberwock's PR Fixer applies high-quality changes to your PRs, right from GitHub. Invoke via a PR comment and it will read the entire comment history to understand context, agreements, and tradeoffs — then implement the right fix.",
	...
	whyBetter: {
		heading: "Why Jabberwock's PR Fixer is different",
		features: [
			{
	...
	cta: {
		...
		description: "Let Jabberwock's PR Fixer turn your review feedback into clean, ready-to-merge commits.",
		buttonText: "Try now for free",
	},
}
