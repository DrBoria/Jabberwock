...
export const content: AgentPageContent = {
	...
	hero: {
		...
		paragraphs: [
			...
			"Jabberwock's PR Reviewer uses advanced reasoning models and full repository context to find the issues that slip through—before they reach production.",
		],
		image: {
			url: hero.src,
			width: 800,
			height: 474,
			alt: "Example of a code review generated by Jabberwock PR Reviewer",
		},
		crossAgentLink: {
	...
	howItWorks: {
		...
		steps: [
			...
			},
			{
				...
				description:
					"Every pull request gets detailed GitHub comments in minutes from a Jabberwock agent highlighting issues and suggesting improvements.",
				icon: "MessageSquareCode",
			},
		],
	},
	whyBetter: {
		heading: "Why Jabberwock's PR Reviewer is different",
		features: [
			{
				...
				paragraphs: [
					...
					"With Jabberwock, you bring your own API key. We optimize prompts for depth, not cost-cutting, so reviews focus on real problems like business logic, security vulnerabilities, and architectural issues.",
				],
				icon: "Blocks",
			},
			{
			...
			},
			{
				...
				description:
					"Jabberwock analyzes your entire codebase context—dependency graphs, code ownership, team conventions, and historical patterns. It understands how changes interact with existing systems, not just whether individual lines look correct.",
				icon: "BookMarked",
			},
		],
	},
