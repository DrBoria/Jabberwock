...
At Jabberwock Vet, the behavior changed. Product managers, support reps, and operations staff started querying the codebase directly through a Jabberwock's Slack agent. The question goes to the agent before it goes to a calendar invite.
...
>
> John Sterns, [Jabberwock Cast S01E11](https://www.youtube.com/watch?v=bqLEMZ1c9Uk&t=290)
...
>
> Theo, [Jabberwock Cast S01E11](https://www.youtube.com/watch?v=bqLEMZ1c9Uk&t=2288)
...
>
> Audrey, [Jabberwock Cast S01E11](https://www.youtube.com/watch?v=bqLEMZ1c9Uk)
...
## How Jabberwock makes questions self-serve
...
**Jabberwock helps non-engineers self-serve codebase questions, reducing engineering interruptions while keeping engineers available for decisions that require judgment.**
...
Modern AI coding agents like Jabberwock explain code in plain language rather than just returning file contents. When a PM asks about pricing logic, they get an explanation of the flow, not a code dump. The agent translates between codebase structure and business concepts.
