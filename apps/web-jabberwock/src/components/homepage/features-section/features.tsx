...
export const features: Feature[] = [
	{
		...
		description:
			"Planning, Architecture, Debugging and beyond: Jabberwock's modes stay on-task and deliver. They even know when to hand off work to other modes. Create your own or download from the marketplace.",
	},
	{
		icon: ReplaceAll,
		title: "Model-agnostic",
		description:
			"Use the Jabberwock cloud Provider, bring your own provider key or even run local inference — no markup, lock-in, no restrictions.",
	...
	},
	{
		...
		description:
			"Control each action and make Jabberwock as autonomous as you want as you build confidence. Or go BRRR and let it rip.",
	},
	{
		icon: Boxes,
	...
	},
	{
		...
		description:
			"Fine-tune settings for Jabberwock to work for you, like inference context, model properties, slash commands and more. Most settings can be global or serialized in your repository.",
	},
	{
		icon: GitPullRequest,
