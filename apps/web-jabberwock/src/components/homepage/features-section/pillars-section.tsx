						...
						<div className="rounded-2xl bg-card outline outline-border/50 hover:outline-8 shadow-lg p-8 h-full group transition-all hover:shadow-2xl">
							...
							<div>
								...
								<div className="text-muted-foreground my-4 space-y-1">
									...
									<p>
										Jabberwock&apos;s Modes keep models focused on a given task and limit their
										access to tools which are relevant to their role, keeping the context window
										clearer and avoiding surprises.
									</p>
									<p>
						...
						<div className="rounded-2xl bg-card outline outline-border/50 hover:outline-8 shadow-lg p-8 h-full group transition-all hover:shadow-2xl">
							...
							<div>
								...
								<div className="text-muted-foreground my-4 space-y-1">
									...
									<p>
										We made Jabberwock thoughtfully configurable to fit your workflow as best it
										can.
									</p>
								</div>
							</div>
							...
							<div>
								...
								<div className="text-muted-foreground my-4 space-y-1">
									<p>
										...
										<Link target="_blank" href="https://github.com/JabberwockInc/Jabberwock">
											open source
										</Link>{" "}
