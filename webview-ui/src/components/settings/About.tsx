				...
				<SearchableSetting
					...
					<p className="text-vscode-descriptionForeground text-sm mt-0">
						<Trans
							...
							components={{
								privacyLink: <VSCodeLink href="https://jabberwock.com/privacy" />,
							}}
						/>
					</p>
				</SearchableSetting>
				...
				<div className="flex flex-col gap-3">
					<div className="flex items-start gap-2">
						...
						<span>
							...
							<VSCodeLink href="https://github.com/JabberwockInc/Jabberwock/issues/new?template=bug_report.yml">
					...
					<div className="flex items-start gap-2">
						...
						<span>
							...
							<VSCodeLink href="https://github.com/JabberwockInc/Jabberwock/issues/new?template=feature_request.yml">
					...
					<div className="flex items-start gap-2">
						...
						<span>
							...
							<VSCodeLink href="https://github.com/JabberwockInc/Jabberwock/security/policy">
					...
					<div className="flex items-start gap-2">
						...
						<span>
							...
							<VSCodeLink href="mailto:support@jabberwock.com">support@jabberwock.com</VSCodeLink>
						</span>
					</div>
					<div className="flex items-start gap-2">
						...
						<span>
							<Trans
								...
								components={{
									redditLink: <VSCodeLink href="https://reddit.com/r/Jabberwock" />,
									discordLink: <VSCodeLink href="https://discord.gg/jabberwock" />,
								}}
							/>
						</span>
					</div>
