...
import { ModeConfig, GroupEntry, PromptComponent, ToolGroup, modeConfigSchema } from "@jabberwock/types"
...
import { Section } from "@src/features/settings/components/Section"
import {
	Button,
	Select,
	SelectContent,
...
const ModesView = observer(() => {
	...
	const customInstructions = rootStore.extensionState.customInstructions
