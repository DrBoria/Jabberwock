...
const McpEnabledToggle = observer(() => {
	const mcpEnabled = rootStore.extensionState.mcpEnabled
	...
	const handleChange = (e: Event | FormEvent<HTMLElement>) => {
		...
		rootStore.setMcpEnabled(target.checked)
		rootStore.settings.updateSettings({ mcpEnabled: target.checked })
	}
