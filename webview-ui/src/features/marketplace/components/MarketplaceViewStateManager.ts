 ...
 *
 * This class manages the state for the marketplace view in the Jabberwock extensions interface.
 *
 * IMPORTANT: Fixed issue where the marketplace feature was causing the Jabberwock extensions interface
...
export class MarketplaceViewStateManager {
	...
	public async handleMessage(message: {
		...
		if (message.type === "state") {
			...
			// The state.marketplaceItems come from EventBridge, see the file src/features/foundation/webview/EventBridge.ts
