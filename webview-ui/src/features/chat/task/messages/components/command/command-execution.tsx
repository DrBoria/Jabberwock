...
import { Button, StandardTooltip } from "@src/features/foundation/ui"
...
export const CommandExecution = observer(({ executionId, text, icon, title }: CommandExecutionProps) => {
	...
	const handleAllowPatternChange = (pattern: string) => {
		...
		rootStore.setAllowedCommands(newAllowed)
		rootStore.setDeniedCommands(newDenied)
