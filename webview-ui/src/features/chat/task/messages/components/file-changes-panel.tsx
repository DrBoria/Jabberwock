...
import type { Notification, ExtensionMessage } from "@jabberwock/types"

import { Collapsible, CollapsibleContent, CollapsibleTrigger } from "@src/features/foundation/ui/collapsible"
...
const FileChangesPanel = memo(({ messages, className }: FileChangesPanelProps) => {
	...
	const fileChanges = useMemo(() => fileChangesFromMessages(messages), [messages])
