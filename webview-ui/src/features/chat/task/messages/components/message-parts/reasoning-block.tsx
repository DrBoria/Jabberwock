...
export const ReasoningBlock = observer(({ content, isStreaming, isLast }: ReasoningBlockProps) => {
	const { t } = useTranslation()
	const reasoningBlockCollapsed = rootStore.extensionState.reasoningBlockCollapsed
