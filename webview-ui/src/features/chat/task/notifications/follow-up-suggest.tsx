...
export const FollowUpSuggest = observer(
	({
		suggestions = [],
		onSuggestionClick,
		ts = 1,
		...
		const alwaysAllowFollowupQuestions = rootStore.settings.alwaysAllowFollowupQuestions
		const followupAutoApproveTimeoutMs = rootStore.settings.followupAutoApproveTimeoutMs
