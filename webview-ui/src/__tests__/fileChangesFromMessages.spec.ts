...
import { fileChangesFromMessages } from "../features/chat/task/messages/components/utils/file-changes-from-messages"

function msg(overrides: Partial<Notification> & { text: string }): Notification {
	return {
		type: "say",
		say: "tool",
		ts: Date.now(),
...
describe("fileChangesFromMessages", () => {
	...
	it("recognizes all SayToolData file-edit tool names (editedExistingFile, appliedDiff, newFileCreated)", () => {
