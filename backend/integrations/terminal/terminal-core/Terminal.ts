...
import type { RooTerminalCallbacks, JabberwockTerminalProcessResultPromise } from "@integrations/terminal/types"
...
export class Terminal extends BaseTerminal {
	...
	constructor(id: number, terminal: vscode.Terminal | undefined, cwd: string) {
		...
		this.terminal = terminal ?? vscode.window.createTerminal({ cwd, name: "Jabberwock", iconPath, env })
