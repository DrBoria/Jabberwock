...
export interface MessageEnhancerOptions {
	...
	customSupportPrompts?: { [key: string]: unknown }
	listApiConfigMeta: Array<{ id: string; name?: string }>
	enhancementApiConfigId?: string
	includeTaskHistoryInEnhance?: boolean
	currentClineMessages?: Notification[]
...
export class MessageEnhancer {
	 ...
	 */
	private static extractTaskHistory(messages: Notification[]): string {
		try {
			...
			console.error("[jabberwock] Failed to extract task history:", error)
			return ""
		}
	}
