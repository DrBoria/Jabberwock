...
import { FileContextTracker } from "../../../../foundation/time-machine/file-context/FileContextTracker"

import { validateAccess, filterPaths } from "@utils/ignore"
	...
	try {
		...
		if (stats.isFile()) {
			...
			for (let index = 0; index < entries.length; index++) {
				...
				let isIgnored = false
				isIgnored = !validateAccess(jabberwockIgnoreController, entryPath, cwd)
