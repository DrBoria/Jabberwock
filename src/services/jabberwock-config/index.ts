 ...
 * ```
 * // macOS/Linux: ~/.jabberwock/
 * // Example: /Users/john/.jabberwock
 *
 * // Windows: %USERPROFILE%\.jabberwock\
 * // Example: C:\Users\john\.jabberwock
 * ```
 *
 * @example Usage:
 * ```typescript
 * const globalDir = getGlobalRooDirectory()
 * // Returns: "/Users/john/.jabberwock" (on macOS/Linux)
 * // Returns: "C:\\Users\\john\\.jabberwock" (on Windows)
 * ```
 */
 ...
 *
 * @param cwd - Current working directory (project path)
 * @returns The absolute path to the project-local .jabberwock directory
 *
 * @example
 * ```typescript
 * const projectDir = getProjectRooDirectoryForCwd('/Users/john/my-project')
 * // Returns: "/Users/john/my-project/.jabberwock"
 *
 * const windowsProjectDir = getProjectRooDirectoryForCwd('C:\\Users\\john\\my-project')
 * // Returns: "C:\\Users\\john\\my-project\\.jabberwock"
 * ```
 *
 * @example Directory structure:
 * ```
 * /Users/john/my-project/
 * ├── .jabberwock/                    # Project-local configuration directory
 * │   ├── rules/
 * │   │   └── rules.md
 ...
 * @returns Array of absolute paths to .jabberwock directories found in subdirectories,
 *          sorted alphabetically. Does not include the root .jabberwock directory.
 *
 * @example
 * ```typescript
 ...
 * // Returns:
 * // [
 * //   '/Users/john/monorepo/package-a/.jabberwock',
 * //   '/Users/john/monorepo/package-b/.jabberwock',
 * //   '/Users/john/monorepo/packages/shared/.jabberwock'
 * // ]
 * ```
 *
 * @example Directory structure:
 * ```
 * /Users/john/monorepo/
 * ├── .jabberwock/                    # Root .jabberwock (NOT included - use getProjectRooDirectoryForCwd)
 * ├── package-a/
 * │   └── .jabberwock/                # Included
 * │       └── rules/
 * ├── package-b/
...
export async function discoverSubfolderRooDirectories(cwd: string): Promise<string[]> {
	try {
		...
		// Use ripgrep to find any file inside any .jabberwock directory
		// This efficiently discovers all .jabberwock folders regardless of their content
		const args = [
			"--files",
			"--hidden",
			"--follow",
		...
		// Extract unique .jabberwock directory paths
		const rooDirs = new Set<string>()
		const rootRooDir = path.join(cwd, ".jabberwock")

		for (const result of results) {
			// Match paths like "subfolder/.jabberwock/anything" or "subfolder/nested/.jabberwock/anything"
			// Handle both forward slashes (Unix) and backslashes (Windows)
			const match = result.path.match(/^(.+?)[/\\]\.jabberwock[/\\]/)
			if (match) {
				const rooDir = path.join(cwd, match[1], ".jabberwock")
				// Exclude the root .jabberwock directory (already handled by getProjectRooDirectoryForCwd)
 ...
 * // Returns:
 * // [
 * //   '/Users/john/.jabberwock',           // Global directory
 * //   '/Users/john/my-project/.jabberwock' // Project-local directory
 * // ]
 * ```
 *
 * @example Directory structure:
 * ```
 * /Users/john/
 * ├── .jabberwock/                    # Global configuration
 * │   ├── rules/
 * │   │   └── rules.md
 * │   └── custom-instructions.md
 * └── my-project/
 *     ├── .jabberwock/                # Project-specific configuration
 *     │   ├── rules/
 ...
 * @example
 * ```typescript
 * // For a monorepo at /Users/john/monorepo with .jabberwock in subfolders
 * const directories = await getAllRooDirectoriesForCwd('/Users/john/monorepo')
 * // Returns:
 * // [
 * //   '/Users/john/.jabberwock',                    // Global directory
 * //   '/Users/john/monorepo/.jabberwock',           // Project-local directory
 * //   '/Users/john/monorepo/package-a/.jabberwock', // Subfolder (alphabetical)
 * //   '/Users/john/monorepo/package-b/.jabberwock'  // Subfolder (alphabetical)
 * // ]
 * ```
 */
export async function getAllRooDirectoriesForCwd(cwd: string): Promise<string[]> {
	...
	// Discover and add subfolder .jabberwock directories
 ...
 *
 * @param cwd - Current working directory (project path)
 * @returns Array of parent directory paths (not .jabberwock paths) containing AGENTS.md or .jabberwock
 *
 * @example
 * ```typescript
...
export async function getAgentsDirectoriesForCwd(cwd: string): Promise<string[]> {
	...
	// Get all subfolder .jabberwock directories
	const subfolderRooDirs = await discoverSubfolderRooDirectories(cwd)

	// Extract parent directories (remove .jabberwock from path)
 ...
 *
 * @param relativePath - The relative path within each .jabberwock directory (e.g., 'rules/rules.md')
 * @param cwd - Current working directory (project path)
 ...
 * // Returns:
 * // {
 * //   global: "Global rules content...",     // From ~/.jabberwock/rules/rules.md
 * //   project: "Project rules content...",   // From /Users/john/my-project/.jabberwock/rules/rules.md
 ...
 *
 * Reads from:
 * - Global: /Users/john/.jabberwock/rules/rules.md
 * - Project: /Users/john/my-project/.jabberwock/rules/rules.md
 *
