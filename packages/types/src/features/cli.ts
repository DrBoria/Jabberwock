...
import { jabberwockSettingsSchema } from "../settings/global/composed.ts"

/**
 * Jabberwock CLI stdin commands
 */
...
export const rooCliStartCommandSchema = rooCliCommandBaseSchema.extend({
	...
	configuration: jabberwockSettingsSchema.optional(),
})
...
/**
 * Jabberwock CLI stream-json output
 */
