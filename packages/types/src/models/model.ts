import { z } from "zod"
import { DynamicProvider, LocalProvider } from "../settings/provider/categories.ts"
...
/**
 * Type guard to check if a key is a model parameter.
 */
export const isModelParameter = (key: string): key is ModelParameter =>
	key === "max_tokens" || key === "temperature" || key === "reasoning" || key === "include_reasoning"
