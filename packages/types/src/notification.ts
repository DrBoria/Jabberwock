...
export function isIdleAsk(ask: NotificationAsk): ask is IdleAsk {
	return (idleAsks as readonly NotificationAsk[]).includes(ask)
}
...
export function isResumableAsk(ask: NotificationAsk): ask is ResumableAsk {
	return (resumableAsks as readonly NotificationAsk[]).includes(ask)
}
...
export function isInteractiveAsk(ask: NotificationAsk): ask is InteractiveAsk {
	return (interactiveAsks as readonly NotificationAsk[]).includes(ask)
}
...
export function isNonBlockingAsk(ask: NotificationAsk): ask is NonBlockingAsk {
	return (nonBlockingAsks as readonly NotificationAsk[]).includes(ask)
}
