...
- **Environment Setup**: Launches VS Code with Jabberwock extension in isolated container
...
- **Development Tools**: VS Code with language-specific extensions and Jabberwock extension
