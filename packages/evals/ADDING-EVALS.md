...
This guide explains how to add new coding exercises to the Jabberwock evals system. The evals system is a distributed evaluation platform that runs AI coding tasks in isolated VS Code environments to test AI coding capabilities across multiple programming languages.
...
- **Exercises Repository**: [`Jabberwock-Evals`](https://github.com/JabberwockInc/Jabberwock-Evals) - Contains all exercise definitions
...
TL;DR - Here's a pull request that adds a new JavaScript eval: https://github.com/JabberwockInc/Jabberwock-Evals/pull/3
...
1. **Clone the evals repository**:
    ...
    ```bash
    git clone https://github.com/JabberwockInc/Jabberwock-Evals.git evals
    cd evals
    ```
...
version = "0.1.0"
description = "Python exercises for Jabberwock evals"
requires-python = ">=3.9"
dependencies = [
    "pytest>=8.3.5",
]
...
Adding a new programming language requires changes to both the evals repository and the main Jabberwock repository.
