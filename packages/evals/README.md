...
Clone the Jabberwock repo:

```sh
git clone https://github.com/JabberwockInc/Jabberwock.git
cd Jabberwock
```
...
By default an evals run will run all programming exercises in [Jabberwock Evals](https://github.com/JabberwockInc/Jabberwock-Evals) repository with the Claude Sonnet 4 model and default settings. For basic configuration you can specify the LLM to use and any subset of the exercises you'd like. For advanced configuration you can import a Jabberwock settings file which will allow you to run the evals with Jabberwock configured any way you'd like (this includes custom modes, custom instructions, etc).
...
- Optionally builds and installs the Jabberwock extension from source
